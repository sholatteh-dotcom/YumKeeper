...
- [x] Fix \_\_dirname deployment error (ESM-safe path resolution)
...
## Expo Development Build Readiness

- [x] Install the Expo development client required by development EAS profiles
- [x] Verify EAS profiles and production configuration remain valid
